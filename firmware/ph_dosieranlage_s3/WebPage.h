...
<main>
  ...
  <section class="card">
    <h2>Anzeige</h2>
    <p class="hint">Das Display geht nach der Standby-Zeit in eine sparsame
       Ansicht, die nur den pH-Wert zeigt und ihn regelmaessig versetzt &mdash;
       schwarze Pixel sind am AMOLED aus. Im Nachtfenster bleibt es ganz dunkel
       und wacht auf Beruehrung auf.</p>
    <div class="grid">
      <div><label>Standby nach [s]</label><input data-k="stby" type="number" step="15" min="15" max="3600"></div>
      <div><label>Position versetzen alle [s]</label><input data-k="shft" type="number" step="30" min="30" max="3600"></div>
      ...
      <div><label>Umdrehungen pro Touch-Freigabe</label><input data-k="prevs" type="number" step="1" min="1" max="20"></div>
    </div>
    <div class="kv" style="margin-top:10px"><span>Zustand</span><b id="dispst">-</b></div>
